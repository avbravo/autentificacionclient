 ...
 */
@Stateless
public class NotificationsTrabajoServices implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc="List<Notifications> findAll()">
    public List<Notifications> findAll() {
        ...
        try {
            ...
            WebTarget target = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/findall");
    ...
    public Boolean add(Notifications notifications) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/add");
...
// <editor-fold defaultstate="collapsed" desc="Boolean update(Notifications notifications)">
    public Boolean update(Notifications notifications) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/update");
...
// <editor-fold defaultstate="collapsed" desc="Boolean delete(Notifications notifications)">
    ...
    public Boolean delete(Notifications notifications) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/delete");
...
// </editor-fold>
    ...
    public Optional<Notifications> findByIdnotifications(Integer idnotifications) {
        ...
        try {
            ...
            notifications = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/search/")
    ...
    public List<Notifications> complete(String query) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/autocomplete/")
                    .path("/{query}")
...
// <editor-fold defaultstate="collapsed" desc=" List<Notifications> jsonQuery(@QueryParam("query") String query , @QueryParam("sort") String sort, @QueryParam("pagenumber") Integer pageNumber, @QueryParam("rowforpage") Integer rowForPage )">
    public List<Notifications> jsonQuery(String query, String sort,
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/jsonquery/")
    ...
    public List<Notifications> jsonQueryWithoutPagination(String query, String sort) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/jsonquerywithoutpagination/")
                    .queryParam("query", JmoordbDocument.encodeJson(query))
                    .queryParam("sort", JmoordbDocument.encodeJson(sort))
                    .request(MediaType.APPLICATION_JSON)
                    .get(new GenericType<List<Notifications>>() {
    ...
    public Integer countJsonQuery(String query) {
        ...
        try {
            ...
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/notificationstrabajo/countjsonquery")
                            .queryParam("query", JmoordbDocument.encodeJson(query));
