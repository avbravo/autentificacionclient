...
import com.avbravo.autentificacionclient.services.BuildingServices;
...
public class BuildingConverter implements Converter {
  ...
  @Override
    public String getAsString(FacesContext context, UIComponent component, Object modelValue) {
        ...
        if (modelValue instanceof Building) {
          return String.valueOf(((Building) modelValue).getIdbuilding());
        } else {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
        ...
        try {
            Optional<Building> optional = buildingServices.findByIdbuilding(Integer.parseInt(submittedValue));
