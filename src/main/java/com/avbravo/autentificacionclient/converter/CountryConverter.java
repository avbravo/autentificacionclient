...
import com.avbravo.autentificacionclient.services.CountryServices;
...
public class CountryConverter implements Converter {
  ...
  @Override
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
        ...
        try {
            Optional<Country> optional = countryServices.findByIdcountry(Integer.parseInt(submittedValue));
