...
// <editor-fold defaultstate="collapsed" desc="List<Role> findAll()">
    public List<Role> findAll() {
        ...
        try {
            ...
            WebTarget target = client.target(microservicesProducer.microservicesHost() + "/autentiticacion/resources/role/findall");
    ...
    public Boolean add(Role role) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentiticacion/resources/role/add");
...
// <editor-fold defaultstate="collapsed" desc="Boolean update(Role role)">
    public Boolean update(Role role) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentiticacion/resources/role/update");
...
// <editor-fold defaultstate="collapsed" desc="Boolean update(Role role)">
    ...
    public Boolean delete(Role role) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentiticacion/resources/role/delete");
...
// </editor-fold>
    ...
    public Optional<Role> findByIdrole(Integer idrole) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            role = client
                    .target(microservicesProducer.microservicesHost() + "/autentiticacion/resources/role/search/")
                    .path("/{idrole}")
    ...
    public List<Role> complete(String query) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentiticacion/resources/role/autocomplete/")
                    .path("/{query}")
