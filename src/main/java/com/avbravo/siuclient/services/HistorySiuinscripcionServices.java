...
@Stateless
@LocalBean
public class HistorySiuinscripcionServices implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc="List<History> findAll()">
    public List<History> findAll() {
        ...
        try {
            ...
            WebTarget target = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/findall");
    ...
    public Boolean add(History history) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/add");
...
// <editor-fold defaultstate="collapsed" desc="Boolean update(History history)">
    public Boolean update(History history) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/update");
...
// <editor-fold defaultstate="collapsed" desc="Boolean delete(History history)">
    ...
    public Boolean delete(History history) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/delete");
...
// </editor-fold>
    ...
    public Optional<History> findByIdhistory(Integer idhistory) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            history = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/search/")
                    .path("/{idhistory}")
    ...
    public List<History> complete(String query) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/autocomplete/")
                    .path("/{query}")
  ...
  public  List<History> jsonQuery( String query ,  String sort,
     Integer pageNumber,  Integer rowForPage ){
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/jsonquery/")                    
  ...
  // <editor-fold defaultstate="collapsed" desc=" List<History> jsonQueryWithoutPagination( @QueryParam("query") String query , @QueryParam("sort") String sort  ){">
   ...
   public List<History> jsonQueryWithoutPagination( String query ,  String sort  ){
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/jsonquerywithoutpagination/")                    
                 .queryParam("query", JmoordbDocument.encodeJson(query))
                    .queryParam("sort",JmoordbDocument.encodeJson(sort))
    ...
    public Integer countJsonQuery(String query) {
        ...
        try {
            ...
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historysiuinscripcion/countjsonquery")
                             .queryParam("query", JmoordbDocument.encodeJson(query));
