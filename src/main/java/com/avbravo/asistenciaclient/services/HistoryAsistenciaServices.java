...
@Stateless
@LocalBean
public class HistoryAsistenciaServices implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc="List<History> findAll()">
    public List<History> findAll() {
        ...
        try {
            ...
            WebTarget target = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/findall");
    ...
    public Boolean add(History history) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/add");
...
// <editor-fold defaultstate="collapsed" desc="Boolean update(History history)">
    public Boolean update(History history) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/update");
...
// <editor-fold defaultstate="collapsed" desc="Boolean delete(History history)">
    ...
    public Boolean delete(History history) {
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/delete");
...
// </editor-fold>
    ...
    public Optional<History> findByIdhistory(Integer idhistory) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            history = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/search/")
                    .path("/{idhistory}")
    ...
    public List<History> complete(String query) {
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/autocomplete/")
                    .path("/{query}")
  ...
  public  List<History> jsonQuery( String query ,  String sort,
     Integer pageNumber,  Integer rowForPage ){
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/jsonquery/")                    
  ...
  // <editor-fold defaultstate="collapsed" desc=" List<History> jsonQueryWithoutPagination( @QueryParam("query") String query , @QueryParam("sort") String sort  ){">
   ...
   public List<History> jsonQueryWithoutPagination( String query ,  String sort  ){
        ...
        try {
            ...
            client.register(authentificationProducer.httpAuthenticationFeature());
            suggestions = client
                    .target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/jsonquerywithoutpagination/")                    
                 .queryParam("query", JmoordbDocument.encodeJson(query))
                    .queryParam("sort",JmoordbDocument.encodeJson(sort))
    ...
    public Integer countJsonQuery(String query) {
        ...
        try {
            ...
            WebTarget webTarget
                    = client.target(microservicesProducer.microservicesHost() + "/autentificacion/resources/historyasistencia/countjsonquery")
                             .queryParam("query", JmoordbDocument.encodeJson(query));
