...
@RequestScoped
@Named
public class NotificationsConverter implements Converter{
    @Inject
   ...
   @Override
    public String getAsString(FacesContext context, UIComponent component, Object modelValue) {
        ...
        if (modelValue instanceof Notifications) {
          return String.valueOf(((Notifications) modelValue).getIdnotifications());
        } else {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
       Notifications a = new Notifications();
        ...
        try {
            Optional<Notifications> optional = notificationsServices.findByIdnotificationsboletas(Integer.parseInt(submittedValue));
