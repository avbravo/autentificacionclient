...
import com.avbravo.asistenciaclient.services.JmoordbEmailMasterServices;
...
public class JmoordbEmailMasterConverter implements Converter{
   ...
   @Override
    public String getAsString(FacesContext context, UIComponent component, Object modelValue) {
        ...
        if (modelValue instanceof JmoordbEmailMaster) {
          return String.valueOf(((JmoordbEmailMaster) modelValue).getEmail());
        } else {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
        JmoordbEmailMaster a = new JmoordbEmailMaster();
        if (jmoordbEmailMasterServices == null) {
        ...
        try {
            Optional<JmoordbEmailMaster> optional = jmoordbEmailMasterServices.findByEmail(submittedValue);
